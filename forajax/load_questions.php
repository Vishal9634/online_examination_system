...
$res=mysqli_query($conn,"select * from questions where catagory='$_SESSION[exam_catagory]'&& question_no=$_GET[questionno]");
    ...
    <tr>
        ...
        <input type="radio" name="r1" id="r1" value="<?php echo $opt1;?>" onclick="radioclick(this.value,<?php echo $question_no ?>)"
          ...
          <td style="padding-left:" 10px>
              ...
              {
                  ?>
              <img src="admin/<?php echo $opt1; ?>" height="50px" width="50px">
              <?php
              }
              else{
                  echo $opt1;
