        ...
        <div class="row" style="margin: 0px; padding:0px; margin-bottom: 50px;">
            ...
            <div class="row">
                ...
                <div class="row" style="margin-top:10px;">
                    <div class="col-lg-6 col-lg-push-3" style="min-hight: 50px;">
...
<script type="text/javascript">
    ...
    //load total_no of  questions function
 ...
 function load_total_que()
    ...
    function load_questions(questionno)
    {
            ...
            if(xmlhttp.readyState==4 && xmlhttp.status==200)
                { 
                    if(xmlhttp.responseText=="over")
                        ...
                        //this function load total num of question 
                        load_total_que();
                      // this function is  run when first question is load 
                    }
                }
     ...
     //radio button function to save answer
